...
gulp.task('copyfonts', function() {
  gulp.src('./node_modules/ionicons/dist/fonts/*.{eot,svg,ttf,woff,woff2}')
    .pipe(gulp.dest('./public/my-projects/hanoi-towers/fonts/ionicons'));
});
...
gulp.task("js", function() {
  gulp.src("./src/js/main.js")
    ...
    .pipe(gulp.dest("./public/my-projects/hanoi-towers/js"));
});
...
gulp.task('sass', function() {
  return gulp.src('./src/sass/*.scss')
    ...
    .pipe(gulp.dest('./public/my-projects/hanoi-towers/css'));
});
